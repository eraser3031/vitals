...
export function SkillInstaller({ onInstalled }: Props) {
  ...
  return (
    <div className="mt-6 px-6 py-5 bg-surface rounded-lg border border-border text-center">
      <h3 className="text-[15px] text-mid mb-2">부검 스킬 설치</h3>
      <p className="text-[13px] text-subtle my-1">Claude Code에서 프로젝트 진단을 하려면 스킬을 먼저 설치해야 해요.</p>
      <button
      ...
      <div className="mt-4 pt-3 border-t border-border">
        <p className="text-[13px] text-subtle my-1">또는 터미널에서 직접:</p>
